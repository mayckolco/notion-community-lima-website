...
export default async function CuentaMapaPage() {
  ...
  return (
    <div className="space-y-8">
      <header className="space-y-2">
        ...
        <h1 className="font-serif text-2xl tracking-tight">Mapa de la comunidad</h1>
        <p className="text-sm text-muted-foreground">
          Explora dónde están los otros miembros y conecta con builders cerca de ti.
        </p>
      </header>
