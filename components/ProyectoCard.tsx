      ...
      <div className="flex items-center gap-4 pt-2">
        {proyecto.url && (
          <a
            ...
            aria-label={`Ver proyecto ${proyecto.nombre} (abre en nueva pestaña)`}
            className="inline-flex items-center gap-1 min-h-[44px] text-xs text-primary hover:underline touch-manipulation focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/60 rounded-sm"
          >
            Ver proyecto
        ...
        {proyecto.github && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            aria-label={`Ver código de ${proyecto.nombre} en GitHub (abre en nueva pestaña)`}
            className="inline-flex items-center gap-1 min-h-[44px] text-xs text-muted-foreground hover:text-foreground transition-colors touch-manipulation focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/60 rounded-sm"
          >
